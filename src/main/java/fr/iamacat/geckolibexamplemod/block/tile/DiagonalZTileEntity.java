...
public class DiagonalZTileEntity extends TileEntity implements IAnimatable, IBBHolder {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(
            new AnimationController<DiagonalZTileEntity>(this, "controller", 0, this::predicate));
    }
