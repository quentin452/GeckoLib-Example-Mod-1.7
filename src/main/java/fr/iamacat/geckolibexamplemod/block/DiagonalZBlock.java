...
public class DiagonalZBlock extends Block implements ITileEntityProvider {

    public AxisAlignedBB boundingBox;

    public DiagonalZBlock() {
        super(Material.rock);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_, int p_149719_2_, int p_149719_3_,
        ...
        if (p_149719_1_.getTileEntity(p_149719_2_, p_149719_3_, p_149719_4_) != null) {
            boundingBox = ((DiagonalZTileEntity) p_149719_1_
                .getTileEntity(p_149719_2_, p_149719_3_, p_149719_4_)).boundingBox;
        } else {
            boundingBox = AxisAlignedBB.getBoundingBox(
                (double) p_149719_2_ + this.minX,
                (double) p_149719_3_ + this.minY,
                (double) p_149719_4_ + this.minZ,
                (double) p_149719_2_ + this.maxX,
                (double) p_149719_3_ + this.maxY,
                (double) p_149719_4_ + this.maxZ);
        }
    }
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new DiagonalZTileEntity();
    }
}
