package fr.iamacat.geckolibexamplemod.entity; // The package our class is located in
...
// Our entity will be derived from the EntityCreature class, meaning that it will be a peaceful creature with some
// simple AI
// It will also implement IAnimatable and IAnimationTickable interfaces, which are required for something to have a
// geckolib animated model
public class GeoExampleEntityZ extends EntityCreature implements IAnimatable, IAnimationTickable {
    ...
    public GeoExampleEntityZ(World worldIn) {
        super(worldIn);
    ...
    // This function is called a predicate. It is used to determine what animation should be played and whether it
    // should play at all
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        event.getController()
            .setAnimation(new AnimationBuilder().addAnimation("animation.bat.fly", true));
        return PlayState.CONTINUE; // And we say that the animation should be played
    }

    // This function is used to register the animation controllers, which will play animations determined by the
    // predicate given
    @Override
    public void registerControllers(AnimationData data) {
        ...
        // To the beginning of the next animation smoothly during those 50 ticks. It can be set to 0 for immediate
    ...
    // This function should return the value of a timer which will increase every tick - the ticksExisted field fits
    // very well for that
    @Override
